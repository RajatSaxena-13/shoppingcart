            ...
            <div className='row'>
                ...
                <div className='col-lg-5 mt-2'>
                    ...
                    <div className='card shadow'>
                        ...
                        <input type = "radio" name = "abc"/> Google Pay UPI <br/><br/>
                            <p class="card-text">All Other Option</p>
                            <input type = "radio" name = "abc"/> UPI <br/>
                            <input type = "radio" name = "abc"/> Wallet / Postpaid  <br/>
                            <input type = "radio" name = "abc"/> Credit / Debit / ATM Card  <br/>
                            <input type = "radio" name = "abc"/> Net Banking  <br/>
                            <input type = "radio" name = "abc"/> Cash On Delivery  <br/><br/>
